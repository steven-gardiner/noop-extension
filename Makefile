...
content/js/firefox-components.js: content/js/firefox-component.js content/js/firefox-button.js content/js/firefox-contextitem.js content/js/firefox-pagewatcher.js
	cat $^ > $@
